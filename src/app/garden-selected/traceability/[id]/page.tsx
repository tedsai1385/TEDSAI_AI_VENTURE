        ...
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-4">
                <div className="bg-white p-8 rounded-3xl shadow-xl text-center max-w-md w-full">
                    ...
                    <Link href="/garden-selected" className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 text-white rounded-xl font-bold hover:bg-emerald-700 transition-colors">
                        <ArrowLeft size={20} />
                        Retour à SelecTED Garden
                    </Link>
                </div>
            </div>
        );
            ...
            <div className="max-w-3xl mx-auto bg-white rounded-[2rem] shadow-xl overflow-hidden print:shadow-none">
                ...
                <div className="bg-emerald-600 p-8 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <Link href="/garden-selected" className="inline-flex items-center gap-2 text-emerald-100 hover:text-white mb-6 transition-colors print:hidden">
                            <ArrowLeft size={20} />
                            Retour
                        </Link>
