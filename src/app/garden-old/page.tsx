                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <h1 className="text-5xl md:text-6xl font-black text-gray-900 mb-6 font-heading">
                                garden & Épicerie <span className="text-garden-primary">SelecTED</span>
                            </h1>

                            <p className="text-xl text-gray-700 mb-6 leading-relaxed">
                                De la graine à l'assiette, découvrez nos produits cultivés avec passion
                                dans notre garden urbain. Traçabilité totale, qualité bio, et soutien
                            ...
                            >
                                <Card hover className="h-full group overflow-hidden">
                                    ...
                                    <CardContent>
                                        ...
                                        <Button variant="primary" className="w-full bg-green-600 hover:bg-green-700" size="sm">
