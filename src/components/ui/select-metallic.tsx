...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ...
        className={cn(
            ...
            "border border-gray-600 bg-gray-900 px-3 py-2 text-sm",
    ...
    <SelectPrimitive.Portal>
        <SelectPrimitive.Content
            ...
            className={cn(
                ...
                // ✅ FOND NOIR MÉTALLIQUE - DÉGRADÉ SUBTIL
                "bg-gradient-to-b from-gray-900 via-gray-950 to-black",
                "border border-gray-700 shadow-2xl",
                // Effet métallique bordure
...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Item
        ...
        className={cn(
            ...
            "text-white",
            // Hover effet métallique
            "focus:bg-gradient-to-r focus:from-blue-900/50 focus:to-blue-800/30",
            "focus:text-blue-100",
            // Sélection active
            "data-[state=checked]:bg-blue-900/30 data-[state=checked]:text-blue-200",
